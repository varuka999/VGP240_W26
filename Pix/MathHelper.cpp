...
Matrix4 MathHelper::Adjoint(const Matrix4& m)
{
    return
    {
        ...
        +(m._11 * ((m._22 * m._44) - (m._42 * m._24)) - m._12 * ((m._21 * m._44) - (m._41 * m._24)) + m._14 * ((m._12 * m._42) - (m._41 * m._22))),
        -(m._11 * ((m._22 * m._34) - (m._32 * m._24)) - m._21 * ((m._21 * m._34) - (m._32 * m._14)) + m._31 * ((m._12 * m._24) - (m._22 * m._14))),
...
float MathHelper::Determinent(const Matrix4& m)
{
    float det = 0.0f;
